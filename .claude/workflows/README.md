...
| `ART-MANIFEST` | Context Management Layer resolution — the minimum load set / checkpoint / cache-state projection produced deterministically by [`../tooling/context-loader.js`](../tooling/context-loader.js) from the authored [`../context/`](../context/README.md) manifests; consumed at Pre-flight (`ART-PREFLIGHT-003`), rebuilt at repository-synchronization, pruned at post-flight (framework-tooling-produced, not authored per candidate; see [../constitution/CONTEXT_ARTIFACTS.md](../constitution/CONTEXT_ARTIFACTS.md) §8) | preflight (Lead Architect) |
