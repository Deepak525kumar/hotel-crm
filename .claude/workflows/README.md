...
| `ART-MANIFEST` | Context Management Layer resolution — the minimum load set for a workflow, resolved deterministically (and statelessly) by [`../tooling/context-loader.js`](../tooling/context-loader.js) from the authored JSON manifests in [`../context/`](../context/README.md); consumed at Pre-flight as `ART-PREFLIGHT-003` (framework-tooling-produced, not authored per candidate; see [../constitution/CONTEXT_ARTIFACTS.md](../constitution/CONTEXT_ARTIFACTS.md) §8) | preflight (Lead Architect) |
