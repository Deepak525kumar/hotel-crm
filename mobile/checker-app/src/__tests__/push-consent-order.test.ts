...
describe('push registration runs only after the consent gate', () => {
  ...
  // blind spot is exactly how this shipped: 2026-08-25 rewrote this app's
  // copy of the file to render {children} unconditionally, underneath an
  ...
  // of this app registered zero push tokens for six days before anyone
