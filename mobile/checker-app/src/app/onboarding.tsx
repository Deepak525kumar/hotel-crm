...
/**
 * Where a checker lands until their EmploymentRecord goes ACTIVE. ADR-065
 * makes this gate universal for every non-Admin role, not just Workers.
 *
 * This screen exists because of two related complaints. The app used to let a
 * PENDING checker straight into the tabs, where nothing worked and a
...
export default function OnboardingScreen() {
  ...
  // user's side -- telling a REJECTED checker to upload more documents would
          ...
          {canSubmit ? (
            <>
              ...
              <Button
                ...
                // review cycle and bounces straight back to the checker.
                disabled={!isComplete}
                accessibilityHint={
