...
import { ThemedText , ThemedView , Radius, Spacing , useTheme } from '@hotel-crm/mobile-shared';
import { BackLink } from '@/components/BackLink';
import { conversationAsText, useChatbotStore, type ChatMessage } from '@hotel-crm/mobile-shared';
