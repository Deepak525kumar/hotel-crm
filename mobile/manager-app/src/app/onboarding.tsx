...
import { ThemedText , ThemedView , Badge, Button, Card, SectionHeader , useAuthStore , api , translateApiError , Spacing , useTheme } from '@hotel-crm/mobile-shared';
...
import type { ContractDto, DocumentCompleteness, WorkerDocument } from '@hotel-crm/mobile-shared';
