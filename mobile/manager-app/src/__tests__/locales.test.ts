/*
 * The locale lockstep, for the shared package.
 *
 * This app has no catalogues of its own -- it renders the ones in
 * `mobile/shared`, so this file is what pins THOSE against the frontend's.
 * worker-app and checker-app each pin their own copies the same way, which
 * makes four sources all anchored to one.
 *
 * The consequence is the part that surprises people: adding a key to the web
 * app alone fails CI here, in a package the branch never opened. Add a string
 * to every catalogue or to none. Never add a dead key just to go green --
 * that trades a failing test for a translation nobody will ever find.
 */
import {
  UI_LOCALES,
  DEFAULT_UI_LOCALE,
  ...
  isRtlLocale,
  negotiateLocale,
} from '@hotel-crm/mobile-shared/src/lib/locales';
...
import de from '@hotel-crm/mobile-shared/src/lib/i18n/locales/de.json';
import en from '@hotel-crm/mobile-shared/src/lib/i18n/locales/en.json';
import ur from '@hotel-crm/mobile-shared/src/lib/i18n/locales/ur.json';
import ar from '@hotel-crm/mobile-shared/src/lib/i18n/locales/ar.json';
import fr from '@hotel-crm/mobile-shared/src/lib/i18n/locales/fr.json';
import uk from '@hotel-crm/mobile-shared/src/lib/i18n/locales/uk.json';
