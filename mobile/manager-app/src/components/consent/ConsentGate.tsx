...
import { ThemedText , ThemedView , Spacing , useTheme , api, setOnConsentRequired , translateApiError , DAILY_ACCESS_GATE_INSTANCE , useAuthStore , useConsentRevisionStore } from '@hotel-crm/mobile-shared';
...
import type { ConsentNotice, ConsentStatus } from '@hotel-crm/mobile-shared';
