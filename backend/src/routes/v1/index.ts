...
router.get('/status', (req, res) => {
  res.json({
    ...
    data: {
      ...
      version: '0.1.0',
      modules: ['auth', 'users', 'crm', 'work-requests', 'work-applications', 'assignments', 'attendance', 'hr', 'calendar', 'documents', 'notifications', 'analytics', 'quality', 'employee-management'],
