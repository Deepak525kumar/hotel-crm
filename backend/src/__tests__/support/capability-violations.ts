...
const VIOLATIONS: readonly CapabilityViolation[] = Object.freeze([
  ...
  //
  // Pin should be REMOVED once ADR-030 ss3 C-12 is amended to reflect D-5's RM grant.
  {
    ...
    authority: "ADR-030 D-5 RM parity decision vs ADR-030 ss3 C-12 (Admin-only in matrix)",
    owner: 'ADR-030 ss3 C-12 amendment',
  },
