...
- **Status:** Proposed — pending human ratification per Engineering Constitution §20, consistent with the ADR-011..020 precedent. Authored by the Lead Architect from the SPEC-CALENDAR-001 first-round G4 architecture review (BLOCKED) and human direction (2026-07-19) to resolve the boundary by narrowing Calendar rather than amending the frozen Job Dispatch specification.
- **Date:** 2026-07-19
