...
- **Status:** Accepted. Ratified directly by the project owner (human decision, recorded 2026-07-22, session `claude/epic-5-verification-next-u5tet9`) — the code this record describes (PR 5.5/5.7/5.8, flag topology) is already implemented and merged as part of Epic 5. This record authorizes **no** runtime change, schema migration, code, or specification edit beyond what was already shipped.
- **Date:** 2026-07-20
