...
| Field | Value |
|---|---|
| Spec ID / version | `SPEC-ANALYTICS-001 / 0.2.0` |
| Status | `FROZEN` |
...
sends none); does not own the mobile/frontend rendering of its data (OQ-ANALYTICS-02 is a
consumer-side finding, not a defect in this module's contract); does not own `ReceptionData`,
