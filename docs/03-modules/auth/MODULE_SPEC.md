...
| Field | Value |
|---|---|
| Spec ID / version | `SPEC-AUTH-001 / 0.2.5` (Document Control previously claimed `0.3.0` with no corresponding Change Log row — corrected to `0.2.4` at the `GD-09` amendment, now `0.2.5` at this `GD-08` amendment) |
