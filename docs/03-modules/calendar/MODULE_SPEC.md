...
| `OD-CAL-09` | Open decision | **Owner unassigned.** No `CODEOWNERS`; empty `backend/package.json` author. | SYNC-001; `TERMINOLOGY.md:44` | Human | Open — freeze requires a named owner/approver |
