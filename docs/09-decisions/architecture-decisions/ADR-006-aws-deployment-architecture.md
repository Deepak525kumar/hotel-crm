...
This record documents the production deployment mechanism currently evidenced in the repository; it is not yet human-ratified. Claims are scoped strictly to repository evidence; unverified AWS services are marked UNKNOWN.
